...
```plaintext
Type A → Type A: 2 × 2 = 4 pathways
Type A → Type B: 2 × 3 = 6 pathways
Type B → Type B: 3 × 3 = 9 pathways
Type B → Type C: 3 × 2 = 6 pathways
Type C → Type C: 2 × 2 = 4 pathways

Total: 4 + 6 + 9 + 6 + 4 = 29 unique pathways
```
